  ...
  return (
    <div style={{ maxWidth: 'var(--measure, 68ch)', margin: '0 auto' }} className="stack">
      ...
      <div className="stack" style={{ padding: 'var(--space-xl, 32px) 0' }}>
        <span className="badge badge-accent" style={{ alignSelf: 'flex-start' }}>New — recurring invoices</span>
      ...
      <div className="card card-overlay" style={{ textAlign: 'center', padding: 'var(--space-xl, 32px)' }}>
