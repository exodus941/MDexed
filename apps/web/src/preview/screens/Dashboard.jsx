  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '180px 1fr', gap: 'var(--space-lg, 32px)', alignItems: 'start' }}>
      <nav className="stack-sm">
        ...
        <div className="nav-item is-active">Overview</div>
      ...
      <div className="stack">
        ...
        <div className="card">
          <div className="row" style={{ justifyContent: 'space-between', marginBottom: 'var(--space-md, 16px)' }}>
            ...
            <span className="badge badge-neutral">4 shown</span>
          </div>
          <table className="table">
            <thead><tr><th>Account</th><th>Status</th><th style={{ textAlign: 'right' }}>Balance</th></tr></thead>
            <tbody>
