      ...
      <div className="stack">
        ...
        <div className="card" {...ins('card')}>
          <div className="row row-wrap" style={{ justifyContent: 'space-between', marginBottom: 'var(--space-md, 16px)' }}>
            <h3 className="t-h6" {...txt('h6')}>Accounts</h3>
        ...
        <div className="cols-2">
          <div className="card" {...ins('card')}>
            <h3 className="t-h6" style={{ marginBottom: 'var(--space-sm, 8px)' }} {...txt('h6')}>{L('Collection rate')}</h3>
          ...
          <div className="card card-overlay" {...ins('card-overlay')}>
            <h3 className="t-h6" style={{ marginBottom: 4 }} {...txt('h6')}>{L('Renewal due')}</h3>
