  ...
  const alignment = [
    ...
    bullets([
      ...
      /* The inversion, learned by making it. Centring a whole title bar to
         ...
         lines. */
      'Count what a row is made of before you choose its alignment. A row that is mostly TEXT takes `align-items: baseline`, and the few boxes in it opt out with `align-self: center`. A row that is mostly fixed-height CONTROLS takes `center`, and any stray run of text opts out. A row of words with a square in it is not a row of squares.',
